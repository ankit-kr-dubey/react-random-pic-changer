...
const App = () => {
    ...
    setInterval(updateTimer, 42000)

    let [uPhoto, setPhoto] = useState("./images/2.jpg")
    const updatePhoto = () => {
        const time = ["./images/5.jpg","./images/6.jpg","./images/7.jpg","./images/1.jpg","./images/5.jpg","./images/6.jpg","./images/7.jpg","./images/1.jpg","./images/2.jpg","./images/3.jpg","./images/4.jpg","./images/5.jpg","./images/6.jpg","./images/7.jpg","./images/1.jpg","./images/2.jpg","./images/3.jpg","./images/4.jpg","./images/5.jpg","./images/6.jpg","./images/7.jpg","./images/1.jpg","./images/2.jpg","./images/3.jpg","./images/4.jpg","./images/5.jpg","./images/6.jpg","./images/7.jpg","./images/1.jpg","./images/2.jpg","./images/3.jpg","./images/4.jpg","./images/5.jpg","./images/6.jpg","./images/7.jpg","./images/1.jpg","./images/2.jpg","./images/3.jpg","./images/4.jpg","./images/5.jpg","./images/6.jpg","./images/7.jpg","./images/1.jpg","./images/2.jpg","./images/3.jpg","./images/4.jpg","./images/5.jpg","./images/6.jpg","./images/7.jpg","./images/1.jpg","./images/2.jpg","./images/3.jpg","./images/4.jpg","./images/5.jpg","./images/6.jpg","./images/7.jpg","./images/1.jpg","./images/2.jpg","./images/3.jpg","./images/4.jpg"];
        // let pTimer = new Date()
        pTimer = time[pTimer.getSeconds()];
        setPhoto(pTimer)
    }
    setInterval(updatePhoto, 42000)
    return (
